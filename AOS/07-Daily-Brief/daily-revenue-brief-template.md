...
| Opportunity | Organisation | Score | Band | Next Action |
|---|---|---|---|---|
| | | | | |

## Recruiters

| Recruiter / Agency | Role | Organisation | Status |
|---|---|---|---|

## Upwork Opportunities

| Listing | Client | Budget | Fit | Status |
|---|---|---|---|---|

## Speaking Opportunities

| Event | Topic | Deadline | Status |
|---|---|---|---|

## Grants

| Grant | Body | Deadline | Relevance | Status |
|---|---|---|---|---|
...
{{LIST: any publication or update to EU AI Act, ISO 42001, NIST AI
RMF, DORA, GDPR, CBUAE AI Principles, RBI AI guidance, or notable AI
security news, from Market Intelligence, and the opportunity each one
creates}}
...
*Compiled from `demand-intelligence`, `02-Content-Director`,
