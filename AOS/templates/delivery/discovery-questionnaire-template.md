...
- Is there a documented risk-tiering method today?

## 4. Operating Model (Govern)

- Who currently approves a new AI use case going live?
- What escalation path exists for an AI-related incident today?
...
*Template only — every answer must come from the actual client
conversation, never inferred or filled in automatically.*
