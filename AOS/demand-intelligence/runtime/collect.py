#!/usr/bin/env python3
"""
Demand Intelligence — Autonomous Collection Engine

(Formerly "Opportunity Hunter" — renamed because its job is no longer
just finding job postings. Its `demandSignals` collector answers a
different question entirely: which named organisations, in the world,
are most likely to need AI for U&I's services this week, based on real
evidence they're deploying AI at scale — before they ever advertise a
vacancy. See collectors/demand_signals.py.)
...
from collectors import (
    ashby, consulting_firms, demand_signals, flexjobs, google_jobs, greenhouse,
...
# demandSignals listed first: it is the highest-value, highest-priority
# discovery mode this employee has (see collectors/demand_signals.py),
# not an equal peer of the job-board collectors below it.
COLLECTORS = {
