...
| `reverse-job-hunt` | Reverse Job Hunt | Added in Sprint 9, additive and downstream of Demand Intelligence only, never modifies any existing scoring logic — for every qualified organisation, generates a Reverse Job Hunt Strategy (why pursue, consulting potential, relevance, AI/governance maturity, entry point, probability of engagement, timeline, first touch, 90-day action sequence) and an Expected Consulting ROI for dashboard sorting — an internal business development playbook, not a proposal |
...
| `reverse-job-hunt` | v1.0 — live operating component, new in Sprint 9: Reverse Job Hunt Strategy per qualified organisation, config, per-organisation strategies, daily Reverse Job Hunt Report ranked by Expected Consulting ROI; purely additive — no change to any existing scoring logic or other employee's code/data (see `reverse-job-hunt/reverse-job-hunt-engine.md`) |
