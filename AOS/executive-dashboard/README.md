...
everything that needs attention across Demand Intelligence, Revenue
...
- **Today's Priorities** runs `09-CEO-Advisor/decision-model.md`
  ...
  Revenue Hunter and Demand Intelligence to a 0-10 value, apply the
...
Everything else (Revenue, Demand Intelligence's views, Revenue Hunter's
